...
export interface ApiCompanyInfoCompanyInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    mainAltColor: Schema.Attribute.String;
    mainBanner: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    mainCarousel: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    mainColor: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    secondColor: Schema.Attribute.String;
    siteLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiGlossaryGlossary extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    short_definition: Schema.Attribute.String;
    slug: Schema.Attribute.UID;
